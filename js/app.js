...
import { sortGapsBySeverity, sortGapsByExposure, sortGapsByRaidPriority, sortEntriesByPriority } from "./engine/sort.js";
...
function recompute() {
  ...
  const exposure = computeExposure(gaps, state.manualCosts);
  ...
  renderRaidTable(els.raidTableBody, sortEntriesByPriority(state.raidEntries));
